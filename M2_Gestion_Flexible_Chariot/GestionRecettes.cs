...
namespace M2_Gestion_Flexible_Chariot
{
    ...
    public class GestionRecettes
    {
        ...
        public static void AfficherMenuRecettes()
        {
            ...
            Console.WriteLine("3. Modification de recettes");
        ...
        public static void CréationRecettes()
        {
            ...
            do
            {
                ...
                Console.WriteLine("");
                nomRecette = GestionPas.VérifierSaisieNom("Nom de la recette : ");
                Console.WriteLine("");
                ...
                try
                {
                    ...
                    choixAjouterRecette = GestionPas.ErreurSaisirChoix("Voulez-vouz ajouter une autre recette (O/N) ? : ", choixAjouterRecette);
                }
            ...
            try
            {
                using (MySqlCommand cmd = GestionBaseDeDonnée.GetMySqlConnection().CreateCommand())
                {
                    ...
                    using (MySqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        Console.WriteLine("\n{0} recette(s) affichée(s).", compteur);
                    }
                }
            }
            catch (MySqlException ex)
        ...
        public static void ModifierNomRecettes()
        {
            ...
            do
            {
                nomRecette = GestionPas.VérifierSaisieNom("Veuillez saisir le nouveau nom de la recette : ");
                    ...
                    try
                    {
                        using (MySqlCommand cmd = GestionBaseDeDonnée.GetMySqlConnection().CreateCommand())
                        {
                            ...
                            if (listeIDRecettes.Contains(id) && nomRecette != "")
                            {
                                ...
                                choixModifierNomRecettes = GestionPas.ErreurSaisirChoix("\nVoulez-vouz modifier une autre recette (O/N) ? : ", choixModifierNomRecettes);
                                Console.WriteLine("");
            ...
            Console.WriteLine("Nombre de recettes modifiés : {0}\n", nbreModifié);
            Console.Write("Veuillez appuyer sur une touche pour continuer... ");
            Console.ReadKey();
        }

        /// <summary>
        /// Stocke les ID de toutes les recettes existantes.
        /// </summary>
        ...
        public static void EffacerRecettes()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Red;
            Console.Write("\nTous les pas associés à la recette choisie seront supprimés.\n");
            Console.ResetColor();
            GestionMenuPrincipale.AttenteSaisieUtilisateur();
            Console.WriteLine("");
                ...
                try
                {
                    using (MySqlCommand cmd = GestionBaseDeDonnée.GetMySqlConnection().CreateCommand())
                    {
                        if (listeIDRecettes.Contains(saisieUtilisateur))
                        {
                            ...
                            choixEffacerRecette = GestionPas.ErreurSaisirChoix("Voulez-vouz effacer une autre recette (O/N) ? : ", choixEffacerRecette);
